...
<!--==========Dependency============-->
<link rel="stylesheet" href="<?php echo get_template_directory(dirname(__FILE__), '') ;?>css/bootstrap.min.css">
<link rel="stylesheet" href="<?php echo get_template_directory(dirname(__FILE__), '') ;?>css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/owl-carousel/assets/owl.carousel.css">
<link rel="stylesheet" href="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/magnific-popup/magnific-popup.css">
...
<link href="<?php echo get_template_directory(dirname(__FILE__), '') ;?>css/theme/green.css" rel="stylesheet">

<!--========== HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries ==========-->
<!--========== WARNING: Respond.js doesn't work if you view the page via file:// ==========-->
<!--==========[if lt IE 9]>
    <script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>js/html5shiv.min.js"></script>
    <script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>js/respond.min.js"></script>
<![endif]==========-->
</head>
<body class="home">

<header class="row black header1 dark-bg" data-spy="affix" data-offset-top="0" id="header">
    <div class="container">
        <div class="row top-header">
            <div class="col-sm-4 search-form-col">
                <form action="#" method="get" class="search-form">
                    <div class="input-group">
                        <span class="input-group-addon"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/search-icon-white.png" alt=""></span>
                        <input type="search" class="form-control" placeholder="search">
                    </div>
                </form>
            </div>
            <div class="col-sm-4 logo-col text-center">
                <a href="index.html"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/logo-white-green.png" alt=""></a>
            </div>
            <div class="col-sm-4 menu-trigger-col">
                <button class="menu-trigger pull-right">
                    <span class="active-page">Blog</span>
                    <img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/menu-align-white.png" alt="" class="icon-burger">
                    <img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/menu-close-white.png" alt="" class="icon-cross">
                </button>
            </div>
        </div>        
    </div>
        ...
        <div class="row">
            <div class="col-md-8 single-post-contents">
                <article class="single-post-content row m0 post">
                    <header class="row">                        
                        <h5 class="post-meta">
                            <a href="#" class="date">feb 17, 2018</a>
                        ...
                        <div class="row">
                            ...
                            <div class="response-count pull-right"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/comment-icon-gray.png" alt="">5</div>
                        </div>
                    </header>
                    <div class="featured-content row m0">
                        <a href="#"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/6.jpg" alt=""></a>
                    </div>
                    <div class="post-content row">
                        ...
                        <div class="thumbCarousel row m0">
                            <div id="slider" class="flexslider">
                                <ul class="slides">
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/1.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/2.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/3.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/4.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/1.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/2.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/3.jpg" alt=""></li>
                                </ul>
                            ...
                            <div id="carousel" class="flexslider">
                                <ul class="slides">
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s1.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s2.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s3.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s4.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s1.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s2.jpg" alt=""></li>
                                    <li><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/gallery/s3.jpg" alt=""></li>
                                </ul>
                    ...
                    <div class="row m0 comments">
                        ...
                        <div class="media comment">
                            <div class="media-left">
                                <a href="#"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/c1.jpg" alt="" class="img-circle"></a>
                            </div>
                            <div class="media-body">
                                ...
                                <div class="media comment reply">
                                    <div class="media-left">
                                        <a href="#"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/posts/c2.jpg" alt="" class="img-circle"></a>
                                    </div>
                                    <div class="media-body">
                                        <h4><a href="#">Mark Sanders</a></h4>
                                        <h5><a href="#" class="date">feb 17, 2018 at 3:30pm</a> | <a href="#" class="reply-link">reply</a></h5>
            ...
            <div class="col-md-4 sidebar">               
                ...
                <aside class="row m0 widget-author widget">
                    <div class="widget-author-inner row">
                        <div class="author-avatar row"><a href="#"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/author.png" alt="" class="img-circle"></a></div>
    ...
    <div class="container">
        <div class="row top-footer">
            <div class="widget col-sm-3 widget-about">
                <div class="row m0"><a href="index.html"><img src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>images/logo-black-green.png" alt=""></a></div>
            </div>
        ...
        <div>
            <h5 class="copyright">All Rights Reserved by Chivalric. Designed and Developed by <a href="https://bootstrapmart.com">BootstrapMart</a><a href="#" class="right-side">&copy; Chivalric 2018</a> </h5>
        </div>
    </div>
</footer>

<!--========== jQuery (necessary for Bootstrap's JavaScript plugins) ==========-->
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>js/jquery-2.2.0.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>js/bootstrap.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/owl-carousel/owl.carousel.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/instafeed/instafeed.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/imagesLoaded/imagesloaded.pkgd.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>vendors/isotope/isotope.pkgd.min.js"></script>
<script src="<?php echo get_template_directory(dirname(__FILE__), '') ;?>js/theme.js"></script>
</body>
</html>